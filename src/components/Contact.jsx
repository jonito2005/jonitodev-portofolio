...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-b from-blue-900/30 to-gray-900/80 backdrop-blur-sm">
          ...
          >
            ...
            >
              {contactInfo.map((info, index) => (
                ...
                >
                  <div className={`flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-full ${info.bgColor}`}>
                    <i className={`${info.icon} text-xl ${info.textColor}`}></i>
                  </div>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4 p-4 rounded-lg bg-gray-800/30">
                <div className="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-full bg-purple-500/20">
              ...
              <div className="flex space-x-4 p-4 rounded-lg bg-gray-800/30">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-4 bg-gradient-to-r from-primary to-secondary text-white rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center space-x-2"
            >
